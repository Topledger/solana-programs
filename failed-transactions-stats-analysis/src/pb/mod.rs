...
pub mod sf {
    pub mod solana {
        ...
        pub mod transaction_stats {
            // @@protoc_insertion_point(attribute:sf.solana.transaction_stats.v1)
            pub mod v1 {
                include!("sf.solana.transaction_stats.v1.rs");
                // @@protoc_insertion_point(sf.solana.transaction_stats.v1)
            }
        }
    }
}
