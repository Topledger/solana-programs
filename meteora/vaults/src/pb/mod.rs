...
pub mod sf {
    pub mod solana {
        pub mod meteora_vaults {
            // @@protoc_insertion_point(attribute:sf.solana.meteora_vaults.v1)
            pub mod v1 {
                include!("sf.solana.meteora_vaults.v1.rs");
                // @@protoc_insertion_point(sf.solana.meteora_vaults.v1)
            }
        }
        pub mod r#type {
