...
pub mod sf {
    pub mod solana {
        ...
        pub mod spl {
            pub mod system {
                pub mod program {
                    // @@protoc_insertion_point(attribute:sf.solana.spl.system.program.v1)
                    pub mod v1 {
                        include!("sf.solana.spl.system.program.v1.rs");
                        // @@protoc_insertion_point(sf.solana.spl.system.program.v1)
                    }
                }
            }
        }
