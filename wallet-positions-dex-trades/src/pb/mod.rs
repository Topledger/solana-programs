    ...
    pub mod solana {
        ...
        pub mod wallet {
            pub mod positions {
                pub mod dex {
                    pub mod trades {
                        // @@protoc_insertion_point(attribute:sf.solana.wallet.positions.dex.trades.v1)
                        pub mod v1 {
                            include!("sf.solana.wallet.positions.dex.trades.v1.rs");
                            // @@protoc_insertion_point(sf.solana.wallet.positions.dex.trades.v1)
                        }
                    }
                }
            }
